...
def test_exoplanet_lc():
    ...
    for photometric_filter in plcl.plc_data.all_filters():
        ...
        for method in ["claret", "sqrt", "quad", "linear"]:
            ...
            for stellar_model in ["phoenix", "atlas"]:
                ...
                transit_integrated = plc.transit_integrated(
                    limb_darkening_coefficients,
                    rp_over_rs,
                    period,
                    sma_over_rs,
        ...
        fp_over_fs = plc.fp_over_fs(
            rp_over_rs, sma_over_rs, 0.2, 1.0, stellar_temperature, photometric_filter
        )
        ...
        eclipse_integrated = plc.eclipse_integrated(
            fp_over_fs,
            rp_over_rs,
            period,
            sma_over_rs,
        ...
        planet_orbit = plc.planet_orbit(
            period, sma_over_rs, 0.1, inclination, 80.0, mid_time, time_array
        )
        ...
        planet_orbit = plc.planet_orbit(
            period, sma_over_rs, 0.1, inclination, 130.0, mid_time, time_array
        )
    ...
    with pytest.raises(plc.PyLCProcessError):
        plc.exotethys(
            1.0, 100000, 30, "JOHNSON_V", method="claret", stellar_model="phoenix"
        )
