...
def test_exoplanet():
    ...
    planet = plc.Planet(
        ...
        sma_over_rs,
        eccentricity,
        plc.Degrees(inclination),
        plc.Degrees(periastron),
        mid_time,
        mid_time_format,
    )
    ...
    eclipse_time_array = np.arange(
        eclipse_mid_time - 0.1, eclipse_mid_time + 0.1, 0.001
    )
    ...
    planet_star_projected_distance = planet.planet_star_projected_distance(
        time_array, "BJD_TDB"
    )
    ...
    for photometric_filter in plcl.plc_data.all_filters():
        ...
        transit_integrated = planet.transit_integrated(
            time_array, "BJD_TDB", 30, "mid", photometric_filter
        )
        transit_integrated = planet.transit_integrated(
            time_array, "BJD_TDB", 30, "start", photometric_filter
        )
        transit_integrated = planet.transit_integrated(
            time_array, "BJD_TDB", 30, "end", photometric_filter
        )

        with pytest.raises(plc.PyLCInputError):
            transit_integrated = planet.transit_integrated(
                time_array, "BJD_TDB", 30, "bla", photometric_filter
            )
        ...
        eclipse_integrated = planet.eclipse_integrated(
            eclipse_time_array, "BJD_TDB", 30, "mid", photometric_filter
        )
        eclipse_integrated = planet.eclipse_integrated(
            eclipse_time_array, "BJD_TDB", 30, "start", photometric_filter
        )
        eclipse_integrated = planet.eclipse_integrated(
            eclipse_time_array, "BJD_TDB", 30, "end", photometric_filter
        )

        with pytest.raises(plc.PyLCInputError):
            eclipse_integrated = planet.eclipse_integrated(
                eclipse_time_array, "BJD_TDB", 30, "bla", photometric_filter
            )
    ...
    data_flux = planet.eclipse_integrated(
        eclipse_time_array, "BJD_TDB", 60, "mid", "COUSINS_R"
    )
    ...
    planet.add_observation(
        ...
        np.ones_like(data_flux) * 0.00001,
        "flux",
        "COUSINS_R",
    )
