...
class MPIPool(object):
    ...
    thirdparty_emcee without shared memory, letting you use much larger machines
    with thirdparty_emcee.

    The pool only support the :func:`map` method at the moment because
    this is the only functionality that thirdparty_emcee needs. That being said,
