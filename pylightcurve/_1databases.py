...
class Databases:
    ...
    def __init__(self):
        ...
        self.clablimb = Database('clablimb', date_to_update='181213').path
        self.oec = Database('oec', date_to_update='daily').path

    def phoenix(self):
        return Database('phoenix', date_to_update='181213', ask_size='5GB').path
